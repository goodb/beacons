...
public class EvidenceApi {
     ...
     */
    public List<InlineResponse2002> getEvidence(String statementId, String keywords, Integer pageNumber, Integer pageSize) throws ApiException {
        ApiResponse<List<InlineResponse2002>> resp = getEvidenceWithHttpInfo(statementId, keywords, pageNumber, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<InlineResponse2002>> getEvidenceWithHttpInfo(String statementId, String keywords, Integer pageNumber, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = getEvidenceCall(statementId, keywords, pageNumber, pageSize, null, null);
     ...
     */
    public com.squareup.okhttp.Call getEvidenceAsync(String statementId, String keywords, Integer pageNumber, Integer pageSize, final ApiCallback<List<InlineResponse2002>> callback) throws ApiException {
