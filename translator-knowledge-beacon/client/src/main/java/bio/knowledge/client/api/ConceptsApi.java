...
public class ConceptsApi {
    ...
    public ApiResponse<List<InlineResponse2001>> getConceptDetailsWithHttpInfo(String conceptId) throws ApiException {
        com.squareup.okhttp.Call call = getConceptDetailsCall(conceptId, null, null);
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<InlineResponse200> getConcepts(String keywords, String semgroups, Integer pageNumber, Integer pageSize) throws ApiException {
        ApiResponse<List<InlineResponse200>> resp = getConceptsWithHttpInfo(keywords, semgroups, pageNumber, pageSize);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<InlineResponse200>> getConceptsWithHttpInfo(String keywords, String semgroups, Integer pageNumber, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = getConceptsCall(keywords, semgroups, pageNumber, pageSize, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getConceptsAsync(String keywords, String semgroups, Integer pageNumber, Integer pageSize, final ApiCallback<List<InlineResponse200>> callback) throws ApiException {
