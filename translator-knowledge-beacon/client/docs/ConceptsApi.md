...
# **getConcepts**
> List&lt;InlineResponse200&gt; getConcepts(keywords, semgroups, pageNumber, pageSize)
...
try {
    List<InlineResponse200> result = apiInstance.getConcepts(keywords, semgroups, pageNumber, pageSize);
    System.out.println(result);
} catch (ApiException e) {
