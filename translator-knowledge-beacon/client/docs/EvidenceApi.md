...
# **getEvidence**
> List&lt;InlineResponse2002&gt; getEvidence(statementId, keywords, pageNumber, pageSize)
...
try {
    List<InlineResponse2002> result = apiInstance.getEvidence(statementId, keywords, pageNumber, pageSize);
